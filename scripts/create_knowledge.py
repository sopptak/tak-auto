...
def main(argv: list[str] | None = None) -> int:
    ...
    print(f"action 요약: {knowledge.action}")
    print(f"decision 요약: {knowledge.decision}")
    print(f"result 요약: {knowledge.result}")
    print(f"lesson 요약: {knowledge.lesson}")
    print(f"reusable_principle 요약: {knowledge.reusable_principle}")
    print(f"evidence 요약: {'; '.join(knowledge.evidence)}")
    print(f"derived_insight: {knowledge.derived_insight}")
    print(f"inference_method: {knowledge.inference_method}")
