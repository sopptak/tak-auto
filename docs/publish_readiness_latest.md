...
| content_id | publish readiness | pending 상태 | 실제 게시 가능 여부 |
| --- | --- | --- | --- |
| content-dbf0fb4eb5cfd791 | NEEDS_HUMAN_REVIEW | pending | 아니오 |
| content-81d4e7c5723598f6 | NEEDS_HUMAN_REVIEW | pending | 아니오 |
...
| content_id | script 존재 | MP4 존재 | YouTube 게시 여부 | 중복 여부 | 업로드 준비 상태 |
| --- | --- | --- | --- | --- | --- |
